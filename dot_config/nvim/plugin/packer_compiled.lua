...
_G.packer_plugins = {
  ...
  ["completion-nvim"] = {
    loaded = true,
    path = "/home/savy/.local/share/nvim/site/pack/packer/start/completion-nvim"
  },
  ["completion-treesitter"] = {
    loaded = true,
    path = "/home/savy/.local/share/nvim/site/pack/packer/start/completion-treesitter"
  },
  ["dashboard-nvim"] = {
    loaded = true,
  ...
  ["vim-rooter"] = {
    loaded = true,
    path = "/home/savy/.local/share/nvim/site/pack/packer/start/vim-rooter"
  },
  ["vim-speeddating"] = {
    loaded = true,
